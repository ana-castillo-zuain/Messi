...
# Convert to sf using END positions
sf_pases <- st_as_sf(pases, coords = c("end_x", "end_y"), crs = NA)
st_crs(sf_pases) <- "+proj=utm +zone=33 +datum=WGS84 +units=m +no_defs"

# KDE — column name passed as a string
kde_result <- sf.kde(x = sf_pases, y = sf_pases$weight)
